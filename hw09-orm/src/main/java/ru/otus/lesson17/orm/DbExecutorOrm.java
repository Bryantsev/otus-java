 ...
 * created on 03.02.19.
 */
public class DbExecutorOrm {

    private static Logger logger = LoggerFactory.getLogger(DbExecutorOrm.class);

    private Map<Class, EntityInfo> entityInfoCache = new HashMap<>();
     ...
     */
    public Object create(Connection connection, Object object) {
        final EntityInfo entityInfo = getEntityInfo(object.getClass());
    ...
    public void createOrUpdate(Connection connection, Object object) {
        final EntityInfo entityInfo = getEntityInfo(object.getClass());
        ...
        try {
            ...
            if (id == null) {
                ...
                Optional<?> obj = load(connection, id, entityInfo.getClazz());
                if (obj.isPresent()) {
    ...
    public <T> Optional<T> load(Connection connection, Object id, Class<T> clazz) {
        if (id == null) {
    ...
    private EntityInfo getEntityInfo(Class<?> clazz) {
        ...
        if (entityInfo == null) {
            ...
            entityInfoCache.put(entityInfo.getClazz(), entityInfo);
        } else {
